...
<script language="javascript">
	...
	<body>
         ...
         <form action="<%=path %>/ruku?type=rukuQuery1" name="formAdd" method="post">
	   <li>
	   	<i>药品</i><a>
<select style="border: 1px solid #C3AB7D;padding:7px 10px 7px 10px;width:150px;"  name="catelog_id" id="catelog_id" onclick="catelogAll()" onchange="goodsAll(this.value)">
	   	...
	   	<i>入库日期</i><a>       <input class="dfinput"  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" style="border: 1px solid #C3AB7D;padding:7px 10px 7px 10px;width:200px"  name="shijian" type="text"/></a>
